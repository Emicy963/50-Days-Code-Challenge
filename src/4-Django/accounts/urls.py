...
urlpatterns = [
    ...
    path('api/auth/refresh/', views.CustomTokenRefreshView.as_view(), name='api_refresh'),
    ...
    path('api/auth/verify-token/', views.TokenVerifyView.as_view(), name='api_verify_token'),
    
    # Profile URLs
    path('api/profile/', views.UserCompleteProfileView.as_view(), name='api_profile'),
    path('api/profile/details/', views.UserProfileDetailView.as_view(), name='api_profile_details'),
    path('api/profile/image/', views.ProfileImageUploadView.as_view(), name='api_profile_image'),
    
    # Password URLs
    path('api/password/change/', views.ChangePasswordView.as_view(), name='api_change_password'),
