...
class Livros(Produto):
    ...
    """
    def __init__(self, nome:str, preco:int, codigo:int, quantidade:int, autor:str, editora:str, numero_paginas:int):
        super().__init__(nome, preco, codigo, quantidade) # Fazer o __init__ da classe pai
        self._autor = autor
...
class Eletronicos(Produto):
    ...
    """
    def __init__(self, nome:str, preco:int, codigo:int, quantidade:int, marca:str, modelo:str, garantia:int):
        super().__init__(nome, preco, codigo, quantidade) # Fazendo o __init__ da classe Pai
